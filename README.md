...
📂 Project Structure FitPulse-Health-Anomaly-Detection/ │ ├── 1_read_excel.py ├── 2_null_check.py ├── 3_clean_data.py ├── 4_gender_analysis.py ├── 5_heart_status.py ├── 6_average_heart_rate.py ├── 7_plot_graphs.py ├── streamlit_app.py ├── Fitpulse_data.xlsx │ ├── outputs/ │ ├── output_screenshots.pdf OR individual images │ └── README.md
...
📊 Features & Tasks Performed ✔ 1. Read Excel dataset
...
▶️ How to Run the Project 1️⃣ Install dependencies pip install pandas numpy matplotlib plotly streamlit scikit-learn openpyxl

2️⃣ Run Python scripts

Example:

python 1_read_excel.py python 2_null_check.py

3️⃣ Run the Streamlit App streamlit run streamlit_app.py
